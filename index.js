...
switch (platform) {
  case 'android':
    switch (arch) {
      case 'arm64':
        localFileExisted = existsSync(join(__dirname, 'serde.android-arm64.node'))
        try {
          if (localFileExisted) {
        ...
        break
      case 'arm':
        localFileExisted = existsSync(join(__dirname, 'serde.android-arm-eabi.node'))
        try {
          if (localFileExisted) {
  ...
  case 'win32':
    switch (arch) {
      case 'x64':
        localFileExisted = existsSync(join(__dirname, 'serde.win32-x64-msvc.node'))
        try {
          if (localFileExisted) {
        ...
        break
      case 'ia32':
        localFileExisted = existsSync(join(__dirname, 'serde.win32-ia32-msvc.node'))
        try {
          if (localFileExisted) {
        ...
        break
      case 'arm64':
        localFileExisted = existsSync(join(__dirname, 'serde.win32-arm64-msvc.node'))
        try {
          if (localFileExisted) {
  ...
  case 'darwin':
    switch (arch) {
      case 'x64':
        localFileExisted = existsSync(join(__dirname, 'serde.darwin-x64.node'))
        try {
          if (localFileExisted) {
        ...
        break
      case 'arm64':
        localFileExisted = existsSync(join(__dirname, 'serde.darwin-arm64.node'))
        try {
          if (localFileExisted) {
  ...
  case 'freebsd':
    ...
    localFileExisted = existsSync(join(__dirname, 'serde.freebsd-x64.node'))
    try {
      if (localFileExisted) {
  ...
  case 'linux':
    switch (arch) {
      case 'x64':
        if (isMusl()) {
          localFileExisted = existsSync(join(__dirname, 'serde.linux-x64-musl.node'))
          try {
            if (localFileExisted) {
          ...
          localFileExisted = existsSync(join(__dirname, 'serde.linux-x64-gnu.node'))
          try {
            if (localFileExisted) {
      ...
      case 'arm64':
        if (isMusl()) {
          localFileExisted = existsSync(join(__dirname, 'serde.linux-arm64-musl.node'))
          try {
            if (localFileExisted) {
          ...
          localFileExisted = existsSync(join(__dirname, 'serde.linux-arm64-gnu.node'))
          try {
            if (localFileExisted) {
        ...
        break
      case 'arm':
        localFileExisted = existsSync(join(__dirname, 'serde.linux-arm-gnueabihf.node'))
        try {
          if (localFileExisted) {
